...
// Create a list of places
        ...
        places.add(new Places(R.string.Muj_salek_title, R.string.Muj_salek_description, R.drawable.muj));
        places.add(new Places(R.string.Unijazz_title, R.string.Unijazz_description, R.drawable.uni));
